			...
			<div className="row">
				...
				<div className="panel-container">
					...
					<div className="panel">
						...
						<div className="info-row">
							<div className="col-1">
								{distressedSales?.medianSalePrice && (
									<>
										<div className="value">
					...
					<div className="panel">
						...
						<div className="info-row">
							<div className="col-1">
								{flipSales?.saleRange1 && (
									<>
										<div className="value">
											<span>
												{numeral(flipSales?.saleRange1).format('$0,')}-
											</span>
											<span>
												{numeral(flipSales?.saleRange2).format('$0,')}
											</span>
										</div>
							...
							<div className="col-2">
								{flipRental && (
									<>
										<div className="value">
											<span>
												{numeral(flipRental?.rentRange1).format('$0,')}-
											</span>
											<span>
												{numeral(flipRental?.rentRange2).format('$0,')}
											</span>
										</div>
										<div className="label" style={{ marginTop: 10 }}>
											Rent Range
