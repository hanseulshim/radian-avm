				...
				{avgListingPrice && (
					<div className="table-container">
						...
						<div className="row">
							...
							{avgListingPrice?.level1PriorMonth ? (
							...
							{avgListingPrice?.level1PriorYear ? (
								<div className="column">
						...
						<div className="row">
							...
							{avgListingPrice?.level2PriorMonth ? (
								<div className="column">
									$
							...
							{avgListingPrice?.level2PriorYear ? (
								<div className="column">
						...
						<div className="row">
							...
							{avgListingPrice?.level3PriorMonth ? (
								<div className="column">
									$
							...
							{avgListingPrice?.level3PriorYear ? (
								<div className="column">
